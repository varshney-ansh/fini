...
const RegisterPage = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <div style={{ display: 'none' }} className={`${styles.phoneform} ${styles.form}`}>
                <h1>Phone number</h1>
                <form action="#">
                    <div className={styles.inputField}>
                        <input type="tel" required placeholder=" " autoComplete="tel-national" pattern="^[0-9]{3,45}$" maxLength={20} />
            ...
            <div style={{display: 'none'}} className={`${styles.form} ${styles.passdialog}`}>
            ...
            <div style={{display: 'block'}} className={`${styles.form} ${styles.passdialog}`}>
